...
- [ ] ⚠️ **Applicare le migration 712 e 713 PRIMA di pushare main** — la 712 (`partner_accounts.terms_version`) e la 713 (categorie a 18, `hidden_dish_categories`, `partner_dishes.notes`, `build_public_menu`). Una seduta sola, in ordine — il portale scrive terms_version all'iscrizione e `notes` sui piatti: senza le colonne, registrazione e salvataggio dei piatti falliscono. A mano dal SQL editor come tutte le 046+. Contesto in memoria `project_menu_privacy_gdpr.md`.
