...
- [ ] **Provare le tre cancellazioni dei file** — è l'unica parte del lavoro sulle foto mai eseguita, ed è la più intricata: (a) foto **sostituita** e salvata → sullo Storage restano due file soli, con identificativo nuovo; (b) foto caricata e maschera **chiusa** con ✕ senza salvare → non resta niente di nuovo; (c) piatto con foto **eliminato** lasciando scadere l'annulla → i suoi due file spariscono. Il resto (giro completo, ritaglio, fascia rossa, Riprova, piatto nuovo acceso in vetrina) è stato verificato nel browser il 31/08
