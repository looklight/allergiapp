...
- [ ] ⚠️ **Applicare la migration 712 (`partner_accounts.terms_version`) PRIMA di pushare main** — il portale la scrive all'iscrizione: senza colonna, la registrazione partner fallisce. A mano dal SQL editor come tutte le 046+. Contesto in memoria `project_menu_privacy_gdpr.md`.
