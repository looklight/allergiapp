...
/**
 * Contenuto del dialog di segnalazione, senza wrapper <Modal>: è un overlay a
 * riempimento assoluto. Va renderizzato dentro un <Modal> (percorso lista
 * recensioni, via ReportReviewModal) oppure dentro un altro overlay/modal già
 * aperto (percorso galleria foto), così non si impilano mai due RN <Modal>
 * nativi — su iOS solo uno può essere presentato per volta.
 *
 * Essendo montato condizionalmente, lo stato (motivo selezionato, invio in
 * corso) si resetta naturalmente a ogni apertura: niente useEffect su `visible`.
 */
export default function ReportReviewPanel({ onClose, onSubmit }: Props) {
