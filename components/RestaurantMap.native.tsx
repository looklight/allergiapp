...
export default function RestaurantMap({ restaurants, centerOn, hasUserLocation, onRegionChangeComplete, selectedId, onDeselect, showMatchInfo, onRestaurantPress }: Props) {
  ...
  const markerElements = useMemo(() =>
    ...
    [restaurants, selectedId, showMatchInfo, onRestaurantPress]
  );
