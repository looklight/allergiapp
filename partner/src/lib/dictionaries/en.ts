...
const en: typeof it = {
  ...
  newVenue: {
    ...
    menuTitle: 'The table menu',
    menuStep1: 'You build your digital menu and put the QR code on the table',
    menuParts: ['Sections', 'Dishes', 'Prices', 'Allergens'],
    menuStep2: 'Guests open it on their phone and pick their allergies: the dishes they can eat come first',
    appTitle: 'The AllergiApp listing',
  ...
  editor: {
    ...
    stepLink: 'Link the venue to your restaurant on AllergiApp and publish',
    stepsSeeSubscription: 'Go to subscriptions',
    ...
    publishRevert: 'Undo',
    publishFailed: 'Not published: some changes aren’t saved. Try again.',
    noDishesSelected: 'No dishes chosen: the dishes section won’t appear in the app.',
  ...
  menus: {
    ...
    deleteOnline: 'It stays at the table until you publish your changes.',
    deleteLastOnline: 'It’s the last active menu: the table menu goes offline.',
  ...
  menuEditor: {
    ...
    publishPending: 'There are changes your guests can’t see yet.',
    publishAfterSave: 'Save your look changes before you can publish them.',
    publishAllergens: 'There are changes your guests can’t see yet, allergens included.',
    publishAppearance: 'The look isn’t visible to your guests yet.',
    ...
    addressTurnOn: 'Make the menu visible to guests',
    addressTurnOff: 'Hide the menu from guests',
    addressHintOffline:
      'The link and the QR code exist but don’t show the menu: whoever opens them reads that it’s not available right now. You can put it back online whenever you want.',
    addressHintLive:
      'This is the address your guests open with the QR code. If you change it, remember to reprint your QR codes.',
    addressHint:
      'This is the address that will go on the table QR code. You can choose it now or when you first publish.',
    ...
    addressChangeConfirmBody:
      'The menu will answer at the new address. Printed QR codes point to the old one: reprint them after the change.',
    addressChangeSureTitle: 'Are you sure?',
    addressChangeSureBody: 'Printed QR codes will stop working.',
    addressChangeSureConfirm: 'Yes, change the address',
  ...
  paywall: {
    lookTitle: 'Make your digital menu yours',
    lookLead: 'The look you choose here reaches your guests at the table too.',
    cardTitle: 'Get found on AllergiApp',
    cardLead: 'People with specific needs open the app before choosing a restaurant.',
    look: 'Customise every detail of your menu’s look',
    card: 'Your venue’s listing inside the app, with your dishes and what they suit',
    replies: 'Reply to your venue’s reviews',
    soon: 'coming soon',
    monthlyName: 'Monthly',
    monthlyPrice: '€7.99',
    perMonth: 'a month',
    yearlyName: 'Yearly',
    yearlyPrice: '€5',
    yearlyBilled: '€60 once a year',
    yearlySave: 'Save €35.88 — 37%',
    yearlyBest: 'Best value',
    perVenue: 'per venue',
    noLock: 'Cancel whenever you want: you stay active until the end of the period you paid for.',
    renewal: 'It renews by itself. Cancel whenever you want: you stay active until the end of the period you paid for.',
    seeAll: 'See subscriptions',
    payError: 'Couldn’t open the payment. Try again.',
    opening: 'Opening…',
    free: 'Creating and publishing your menu stays free, and always will be.',
    cta: 'Activate the Pro plan',
    ctaSoon: 'Go to subscriptions',
    later: 'Not now',
  },
  subs: {
    back: 'Back',
  ...
  cardState: {
    ...
    line: {
      ...
      closed: 'Our team closed the link: you’ll find the reason on the listing.',
    ...
    notice: {
      ...
      reason: 'Reason:',
      closedTitle: 'Link revoked by our team',
      closedNeverApprovedTitle: 'Link not approved',
      closedText: 'The link to {restaurant} was closed and the listing isn’t shown in the app.',
  ...
  reviews: {
    title: 'Reviews',
    intro: 'Reviews of {restaurant} on AllergiApp. Your reply appears under the review, with your venue’s logo.',
    filterTodo: 'To answer ({n})',
    filterAll: 'All ({n})',
    empty: 'No reviews on AllergiApp yet.',
    emptyTodo: 'You have answered every review.',
    emptyStars: 'No reviews with this rating.',
    loadError: 'We couldn’t load the reviews. Please try again shortly.',
    retry: 'Try again',
    anonymous: 'Anonymous user',
    needs: 'Their needs',
    edited: 'Edited after your reply',
    reply: 'Reply',
    yourReply: 'Your reply',
    placeholder: 'Write a reply…',
    tips: 'Try to say thanks and answer the point in a friendly way. When facing criticism, stay calm: readers look above all at how you reply.',
    identityTitle: 'How you appear in replies',
    starsAll: 'All ratings',
    starsLabel: 'Filter by rating',
    summaryCount: '{n} reviews',
    summaryRow: '{n} stars: {count}',
    counter: '{n}/{max}',
    save: 'Publish',
    cancel: 'Cancel',
    edit: 'Edit',
    delete: 'Delete',
    saveError: 'The reply wasn’t saved. Please try again.',
    deleteError: 'The reply wasn’t deleted. Please try again.',
    deleteTitle: 'Delete the reply?',
    deleteBody: 'It disappears from the app. You can write another one whenever you like.',
    removedTitle: 'Removed by the AllergiApp team',
    removedReason: 'Reason: {note}',
    removedHint: 'It is no longer visible in the app and can’t be edited. For questions, write to info@allergiapp.com.',
    unavailableTitle: 'Replying to reviews is Pro',
    unavailableBody: 'You can reply with an active subscription and your venue linked to its restaurant on AllergiApp, once our team has checked it.',
    unavailableCta: 'Open the listing',
  },
};
