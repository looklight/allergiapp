...
const en: typeof it = {
  ...
  menus: {
    ...
    venueHint: 'It appears at the top of the menu, your guests read it. We ask only once.',
    menuNameLabel: 'Menu name',
    menuNameHint: 'Whatever you call it: À la carte, Lunch, Drinks.',
    empty: 'You have no menus yet.',
    emptyHint: 'Create one: the dishes come from your catalogue, no need to type them again.',
    noShowcase: 'You need a showcase before you can create a menu.',
    noShowcaseHint: 'A menu belongs to a venue, and the showcase is the venue.',
