...
const en: typeof it = {
  ...
  menuEditor: {
    ...
    lineHeightSample: 'two lines',
    textScaleFloor: 'The allergen line never shrinks: it stays readable even on the tightest setting.',
    photos: 'Dish photos',
    photoShapes: { none: 'None', square: 'Square', round: 'Round' },
    photosHint: 'With no photos the table menu is text only. Photos stay on the dishes and on the AllergiApp card.',
