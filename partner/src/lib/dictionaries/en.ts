...
const en: typeof it = {
  ...
  paywall: {
    lookTitle: 'Your table menu, your face',
    lookLead: 'You picked colours and fonts: with the Pro plan your guests see them too.',
    cardTitle: 'Get found by people with allergies',
    cardLead: 'The Pro plan puts your venue inside the app, where people look for a place to eat.',
    look: 'Your table menu with your logo, your colours and your font',
    card: 'Your venue’s listing inside the app, with your dishes and your links',
    replies: 'Replies to reviews, signed by your venue',
    soon: 'coming soon',
    monthlyName: 'Monthly',
    monthlyPrice: '€7.99',
    perMonth: 'a month',
    ...
    opening: 'Opening…',
    free: 'The menu, the QR code and the allergen filter stay free, always.',
