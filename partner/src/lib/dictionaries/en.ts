...
const en: typeof it = {
  ...
  paths: {
    title: 'What you can do with AllergiApp',
    intro:
      'It all starts with a venue: from there you create the digital menu and the listing in the app. They’re independent, you can do just the first.',
    label: 'What you can do with this venue',
    free: 'Free',
    menuTitle: 'The table menu',
    menuText:
      'Sections, dishes, prices and allergens. Guests scan the QR code and pick their allergy: the menu shows first the dishes they can eat.',
    menuShort: 'The digital menu with a QR code: guests filter it by their allergies.',
    appTitle: 'The AllergiApp listing',
    appText:
      'Your links and the dishes you pick, on your restaurant’s page in the app, where people with allergies look for places to eat. Coming soon.',
    appShort: 'Links and dishes on your restaurant’s page in the app.',
    sampleFilter: 'No',
    sampleDishOk: 'Seafood salad',
    sampleDishNo: 'Spaghetti carbonara',
    sampleVenue: 'Your venue',
    sampleRestaurant: 'Your restaurant on AllergiApp',
