const it = {
  ...
  menus: {
    ...
    venueHint: 'Compare in cima al menù, lo leggono i tuoi clienti. Lo chiediamo una volta sola.',
    menuNameLabel: 'Nome del menù',
    menuNameHint: 'Come lo chiami tu: Carta, Pranzo, Bevande.',
    empty: 'Non hai ancora nessun menù.',
    emptyHint: 'Creane uno: i piatti li prendi dal tuo catalogo, senza riscriverli.',
    noShowcase: 'Per creare un menù ti serve prima una vetrina.',
    noShowcaseHint: 'Il menù appartiene a un locale, e la vetrina è il locale.',
