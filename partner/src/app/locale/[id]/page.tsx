            ...
            <div className="min-w-0 flex-1">
              ...
              <ol className="mt-2 flex flex-col gap-1.5 sm:flex-row sm:items-stretch">
                {[
                  ...
                  <Fragment key={i}>
                    {i > 0 && (
                      <svg className="mx-auto h-4 w-4 shrink-0 rotate-90 self-center text-amber-500 sm:rotate-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                        <path d="M5 12h14M13 6l6 6-6 6" />
                      </svg>
                    )}
                    <li className="flex flex-1 items-start gap-2 rounded-lg border border-amber-100 bg-white px-3 py-2 text-gray-600">
                      {fatto && (
              ...
              <Link
                href={verso}
                className="mt-2 inline-block font-medium text-gray-700 underline underline-offset-2 transition-colors hover:text-gray-900"
              >
