...
export default function AnnouncementPopup() {
  ...
  const checkPopup = async () => {
    ...
    setVisible(true);
    Analytics.logBannerViewed(announcement.id, resolveText(announcement.title, getAppLanguage()));
  ...
  const handleButton = async () => {
    if (!popup) return;
    Analytics.logBannerClicked(popup.id, resolveText(popup.title, getAppLanguage()));
