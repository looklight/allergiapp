...
const DICTIONARIES = {
  it: {
    ...
    menuDetailNotes: 'Da sapere',
    // Il titolo della legenda della modalità a icone (v. renderLegenda)
    menuIconsLegend: 'Cosa vogliono dire le icone',
    ...
    menuLanguage: 'Lingua',
    menuTabsLabel: 'I menù del locale',
    menuTabFallback: 'Menù {n}',
    // La riga del marchio in coda al menù. Il NOME resta fuori dalla
    // traduzione: "AllergiApp" si scrive uguale in tutte le lingue.
    menuBrandBy: 'Realizzato con',
    // Detta al tavolo, non in una pagina legale: è l'unica riga che il
    // cliente leggerà davvero. Il link all'informativa completa è nel piede.
    menuPrivacyNote: 'Questa pagina non usa cookie. Le esigenze che selezioni restano sul tuo telefono.',
  },
  en: {
    pageTitle: '{name} · {city} | AllergiApp',
    ...
    menuDetailNotes: 'Good to know',
    menuIconsLegend: 'What the icons mean',
    ...
    menuTabsLabel: 'The venue’s menus',
    menuTabFallback: 'Menu {n}',
    // La riga del marchio in coda al menù. Il NOME resta fuori dalla
    // traduzione: "AllergiApp" si scrive uguale in tutte le lingue.
    menuBrandBy: 'Made with',
    menuPrivacyNote: 'This page uses no cookies. The needs you select stay on your phone.',
  },
};
