...
module.exports = {
  ...
  logoUrl: '',
  // Immagine dietro l'intestazione, al posto del colore pieno. Vuota = resta
  // il colore. La colonna c'è dalla 709; il caricamento nel portale no.
  coverUrl: '',
  // Carattere delle INTESTAZIONI (nome del locale, titoli delle sezioni):
  // 'modern' | 'classic' | 'bold' | 'light'. Il corpo del menù e la riga
  // degli allergeni non cambiano mai (Tema 25). La colonna c'è dalla 709; i
  // file e la scelta nel portale no.
  headingFont: 'modern',
  // Come si vedono i titoli delle sezioni: 'underline' (filetto, quello di
  // oggi) | 'banner' (fascia col colore del locale) | 'plain' (solo testo).
    ...
    groups: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            priceCents: 700,
            highlighted: true,
            highlightNote: 'Il piatto del mese',
            allergens: ['gluten'],
