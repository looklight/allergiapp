...
<body>
${renderSmartBannerAndroid(r, locale, t, deepLink)}
${renderNav(locale)}
...
function renderSmartBannerAndroid(r, locale, t, deepLink) {
  ...
  <div class="smart-banner-text">
    ...
    <span class="smart-banner-subtitle">${escapeHtml(t('smartBannerSubtitle'))}</span>
  </div>
...
function renderInlineScript(deepLink) {
